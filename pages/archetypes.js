...
const Archetypes = ({ homepage }) => {
    ...
    let storyteller  = { name: "The Storyteller", slug: "storyteller",
                         image: "https://res.cloudinary.com/mymediacreative/image/upload/c_scale,w_900/v1657362484/the%20harbour/archetype%20illustrations/Storyteller-square_wwleoc.png", }
    let organizer    = { name: "The Organizer", slug: "organizer",
                         image: "https://res.cloudinary.com/mymediacreative/image/upload/c_scale,w_900/v1657362470/the%20harbour/archetype%20illustrations/Organizer-square_h0ix8t.png", }
    let architect    = { name: "The Architect", slug: "architect",
                         image: "https://res.cloudinary.com/mymediacreative/image/upload/c_scale,w_900/v1657362444/the%20harbour/archetype%20illustrations/Architect-square_mtypwo.png", }
    let scientist    = { name: "The Scientist", slug: "scientist",
                         image: "https://res.cloudinary.com/mymediacreative/image/upload/c_scale,w_900/v1657362497/the%20harbour/archetype%20illustrations/Scientist-square_xec7ux.png", }
    let entrepreneur = { name: "The Entrepreneur", slug: "entrepreneur",
                         image: "https://res.cloudinary.com/mymediacreative/image/upload/c_scale,w_900/v1657362414/the%20harbour/archetype%20illustrations/Entrepreneur-square_wqk53w.png", }
    let reformer     = { name: "The Reformer", slug: "reformer",
                         image: "https://res.cloudinary.com/mymediacreative/image/upload/c_scale,w_900/v1657362463/the%20harbour/archetype%20illustrations/Reformer-square_rcafgh.png", }
